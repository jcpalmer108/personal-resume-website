...
export const LandingWrapper = styled.div`
  ...
  background: -moz-linear-gradient(0deg, rgba(255,209,184,1) 0%, rgba(255,237,227,1) 100%);
  background: -webkit-linear-gradient(0deg, rgba(255,209,184,1) 0%, rgba(255,237,227,1) 100%);
